...
pub fn create_keyboard_layout(keyboard_layout: Vec<Vec<String>>, strategy: Strategy) -> Vec<String> {
    match strategy {
...
fn turn_horizontal_into_vertical_keyboard_layout(keyboard_layout: Vec<Vec<String>>) -> Vec<Vec<String>> {
